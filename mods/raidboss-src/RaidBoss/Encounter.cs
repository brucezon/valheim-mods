...
internal sealed class Encounter
{
	...
	internal static readonly HashSet<string> Verbs = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "ward", "guard", "shield", "boss", "strike", "chase", "rain", "break", "heal", "weather", "effect", "status" };
