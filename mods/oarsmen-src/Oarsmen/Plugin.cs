...
public class OarsmenPlugin : BaseUnityPlugin
{
	...
	private void Awake()
	{
		...
		BonusPerRower = config("2 - Rowing", "Paddle force per rower (x)", 0.35f, "Extra paddle force per seated rower, as a fraction of the ship's paddle force. 0.35 with 4 rowers = 2.4 times the vanilla paddle force. Speed rises less than force because water drag grows with speed. Applies to reverse as well as forward.");
